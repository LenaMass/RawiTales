...
////  ch5
////
////  Created by Reem Alghamdi on 18/08/1447 AH.
////
//
//let stories: [Story] = [
////1.
...
//        ),
//
//        summary: "In a simple journey that quickly turns unexpected, Juha and his son try to please everyone they meet — only to face criticism at every turn. This humorous tale delivers a timeless lesson about the danger of living by others’ opinions, reminding readers that pleasing everyone is an impossible goal."
//    ),
////2.
//    Story(
//        title: "The Fisherman and the Shining Pearl",
